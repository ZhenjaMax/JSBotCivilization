...
function getEmbed_Remap(){
    const embedMsg = new Discord.MessageEmbed()
        ...
        **В случае поражения одного из игроков, ремап и авторемап проводить запрещается.**
        ...
        • Вы не можете основать 3 новых города в радиусе 5 клеток от своего изначального местоположения (без учета других городов, кроме столиц и городов-государств) без изучения дополнительных технологий или социальных институтов на игровых картах:
			• Пангея;
			• Континенты;
			• Нагорье;
			• Внутреннее море;
...
function getEmbed_Scrap(){
    const embedMsg = new Discord.MessageEmbed()
		...
		• При невыполнении ни одного из условий выше: любой ход – единогласно.
