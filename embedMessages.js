...
function getEmbed_Remap(){
    const embedMsg = new Discord.MessageEmbed()
        ...
        Авторемап гарантирован в случае, если вы не можете основать 3 новых города в радиусе 5 клеток от своего изначального местоположения (без учета других городов, кроме столиц и городов-государств) без изучения дополнительных технологий или социальных институтов.
        `);
    return embedMsg;
}
...
function getEmbed_Split(capitanIndex, teamPlayers, splitStatus = 0){    // 0 = default, 1 = first, 2 = last & ready
    const embedMsg = new Discord.MessageEmbed()
        .setTitle("🐲 Разделение на команды")
        .setColor("#35f00f");
    switch(splitStatus){
        case 0:
            break;
